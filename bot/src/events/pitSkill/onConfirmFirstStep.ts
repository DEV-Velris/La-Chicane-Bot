...
const event: BotEvent = {
  ...
  async execute(interaction: Interaction): Promise<void> {
    if (!interaction.isButton() || interaction.customId !== 'link_pitskill_first_step') return;
    ...
    try {
      ...
      const inputRow = new ActionRowBuilder<TextInputBuilder>().addComponents(pitSkillTextInput);
